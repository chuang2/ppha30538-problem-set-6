...
crosswalk = crosswalk.fillna("Unclassified")
...
#if subtype in one of the three hazard subsubtypes, return a special subtype
#otherwise return the value as is...BUT it needs to be cleaned instead of being in all caps/underscores
...
crosswalk['updated_subtype'] = crosswalk['subtype'].apply(modify_type)
